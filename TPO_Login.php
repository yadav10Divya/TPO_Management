...
<body>
    ...
    <button type="button" id="logout" class=" mybutton btn btn-info" name="logout" onclick="window.open('index.html','_self');">Logout</button>
    </div>
        <!-- Header Start >
                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <u><a href="TPO_Register.php" name="forgot_password" style="font-size:18px;color:blue">Registration</a></u>
...
if(isset($_POST['signin'])){
    $query = "SELECT * FROM `tporegister` WHERE `username`='$_POST[username]' AND `password`='$_POST[password]'";
