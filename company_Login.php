                            ...
                            <div class="row register-form">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <u><a href="company_Register.php" name="forgot_password" style="font-size:18px;color:blue">Registration</a></u>
...
if(isset($_POST['signin'])){
    $query = "SELECT * FROM `CompanyRegister` WHERE `username`='$_POST[username]' AND `password`='$_POST[password]'";
