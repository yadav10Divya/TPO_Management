...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-body-wrapper">
            ...
            $sql = "select sname,eno,companyid,status from approval where eno='$sid'";
            $query=mysqli_query($conn,$sql); 

            $sql1 = "select checkboxValue,status from selected_student where checkboxValue='$sid'";
            $query1=mysqli_query($conn,$sql1); 
    
                while($res=mysqli_fetch_array($query)){
                    while($res1=mysqli_fetch_array($query1)){
                
                    // $query2 = "select company from company_info where id='$res[companyid]'";
